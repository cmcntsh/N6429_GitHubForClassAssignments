# GitHub for Class Assignments

You can see a video demonstration of this assignment at https://youtu.be/vPZYkuGx4ko.
...
You can manually upload files to GitHub.
...
## Create .txt files directly in GitHub

You can create a .txt file and write content to it directly in GitHub.

* Click on the Add file button in the main repository window
* Click on + Create new file
* Enter the name you want to use for the new file in the Name your file... field near the top of the window
* Type the text you want to be included in the file in editor window where it says "Enter file contents here"
* Click the green "Commit changes..." button near the top of the window
